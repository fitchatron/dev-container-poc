...
<template>
  ...
  <div class="flex flex-col md:flex-row items-center place-content-around bg-indigo-300">
    ...
    <div class="flex flex-col items-center">
      ...
      <button
        ...
        type="button"
        @click.prevent="counterStore.toggleShowGuide()"
      >
        Shop Now
      </button>
    </div>
  ...
  <div class="space-y-4 px-4 py-2">
    ...
    <form class="flex flex-col gap-4 px-4">
      ...
      <div class="flex items-center flex-col" v-page-guide="'Look at my awesome element'">
